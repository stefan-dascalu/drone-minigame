...
namespace implemented
{
    class Cameras
    {
     public:
        ...
        Cameras(const glm::vec3 &position, const glm::vec3 &center, const glm::vec3 &up)
        {
        ...
        {
            // Translates the Cameras using the `dir` vector computed from
            // `forward`. Movement will always keep the Cameras at the same
        ...
        {
            // TODO(student): Translate the Cameras using the `forward` vector.
        ...
        {
            // TODO(student): Translate the Cameras using the `up` vector.
        ...
        void TranslateRight(float distance)
        {
            ...
            // You need to translate the Cameras using the `right` vector.
            // Usually, however, translation using Cameras's `right` vector
            // is not very useful, because if the Cameras is rotated around the
            // `forward` vector, then the translation on the `right` direction
            // will have an undesired effect, more precisely, the Cameras will
        ...
        {
            // TODO(student): Rotate the Cameras in third-person mode around
